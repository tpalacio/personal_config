...
;; added this from http://code.google.com/p/emacs-textmate/issues/detail?id=5

;; (defun textmate-minor-mode-on ()
;;   "Turn on Textmate minor mode."
;;   (interactive)
;;   (textmate-minor-mode 1))
;; 
;; (define-globalized-minor-mode textmate-global-mode textmate-minor-mode
;; textmate-minor-mode-on
;;   :group 'textmate)
;; 
;; (defun textmate-initialize ()
;;   "For backward compatibility, enable `textmate-minor-mode' globally"
;;   (textmate-global-mode 1))
